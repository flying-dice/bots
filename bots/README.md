...
Install with `bots install --all --faction decepticons --harness claude --scope user`
...
in Starscream's definition. See the [project README](../README.md) for both factions.
