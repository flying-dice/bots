---
name: prowl-deep
description: Autobots architect, high effort (Fable). Reserved for hard-to-reverse, system-wide decisions; requires written justification from Silverbolt. Read-only.
model: fable
effort: high
color: blue
