---
name: skydive
description: Aerialbots senior developer (Opus, medium effort). Multi-file changes, tricky bugs, refactors, code review. Dispatched only by Silverbolt.
model: opus
effort: medium
color: orange
